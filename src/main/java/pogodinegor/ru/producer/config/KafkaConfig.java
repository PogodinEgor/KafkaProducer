package pogodinegor.ru.producer.config;
...
public class KafkaConfig {
    ...
    public NewTopic employeeTopic() {
        return TopicBuilder.name("employee-lists")
                .partitions(5)
                .replicas(1)
    ...
    public NewTopic phoneTopic() {
        return TopicBuilder.name("phone-lists")
                .partitions(5)
                .replicas(1)
                .config(TopicConfig.RETENTION_MS_CONFIG,
                        String.valueOf(Duration.ofDays(7).toMillis())
    ...
    @Bean
    public NewTopic employeePhoneLinkTopic() {
        return TopicBuilder.name("employeePhoneLink-lists")
                .partitions(5)
                .replicas(1)
                .config(TopicConfig.RETENTION_MS_CONFIG,
                        String.valueOf(Duration.ofDays(7).toMillis())
